...
<script>
    define(["Vue", "vuex", "vue_router", "routes", "bootstrap-vue", "vue!search-component.vue", "vue!search-rightcomponent.vue"], function (Vue, Vuex, VueRouter, appRoutes, BootstrapVue, searchComponent) {
