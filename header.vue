				...
				<div class="row header_logo">
					...
					<div class="col-md-3 hidden_phone">
					    <div class="header_search_container">
    					    <search-component v-model="search" :list="searchList" :keys="keys" :suggestion-attribute="suggestionAttribute" :minMatchCharLength="3" :tokenize="false" @select="onOptionSelect">
