<template>
    ...
    <div class="container">
        ...
        <div id="chaticon" class="animated swing infinite" @click="showChat = !showChat"> <!-- data-toggle="modal" data-target="#chat_modal" -->
        ...
        <!--Modal -->
        <div v-if="showChat" id="chat_modal" :class="'modal' + { show: showChat }" > <!-- class="modal"  tabindex="-1" role="dialog" aria-labelledby="chat_modalLabel" -->
