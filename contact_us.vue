        		...
        		<div class="site_container">
                    ...
                    <div class="contact_container clearfix">
					    ...
					    <div class="contact_content">
					        ...
					        <a :href="'mailto:' + property.contact_email" target="_blank"><p>{{ property.contact_email }}</p></a>
					    </div>
					        ...
					        <form id="contact_form" class="form-horizontal" action="form-submit" @submit.prevent="validateBeforeSubmit">
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="center">
                                            <button class="submit_btn animated_btn swing_in" type="submit" :disabled="formSuccess">{{ $t("contact_page.form_send") }}</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
